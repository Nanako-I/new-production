    ...
    <div x-data="{ open: false }" @click.away="open = false" @close.stop="open = false" class="relative">
        ...
        <div x-show="open"
            ...
            <div class="rounded-md ring-1 ring-black ring-opacity-5 py-1 bg-white dark:bg-gray-700">
                ...
                <x-dropdown-link :href="'https://www.canva.com/design/DAGaQcw6Ibo/MOaJx25WLW4qAaUVdLNCvQ/watch?utm_content=DAGaQcw6Ibo&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=ha8d052376b'" class="text-lg">
                    {{ __('使い方②') }}
                </x-dropdown-link>
