      ...
      <form id="eventForm" class="p-6" method="POST">
        ...
        <div class="grid grid-cols-2 gap-6">
          <div>
            ...
            <input type="date" id="arrival-date" name="arrival-date" readonly class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500">
          </div>
          <!-- <div>
          ...
          <div>
            ...
            <input type="date" id="exit-date" name="exit-date" readonly class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500">
          </div>
          <!-- <div>
        ...
        <div class="grid grid-cols-2 gap-6">
          <div>
            ...
            <div class="mt-1 flex space-x-4 border border-gray-300 rounded-md px-3 py-2">
              <div class="flex items-center">
                <input type="radio" id="pick_up" name="pick_up" value="必要" required class="mr-2">
                <label for="pick_up_yes" class="text-sm">必要</label>
              </div>
              <div class="flex items-center">
                <input type="radio" id="pick_up" name="pick_up" value="不要" required class="mr-2">
          ...
          <div>
            ...
            <div class="mt-1 flex space-x-4 border border-gray-300 rounded-md px-3 py-2">
              <div class="flex items-center">
                <input type="radio" id="drop_off" name="drop_off" value="必要" required class="mr-2">
                <label for="drop_off_yes" class="text-sm">必要</label>
              </div>
              <div class="flex items-center">
                <input type="radio" id="drop_off" name="drop_off" value="不要" required class="mr-2">
        ...
        <div class="mt-6">
          ...
          <textarea
            ...
            name="notes"
            rows="3"
            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 resize-y"
